...
import project.fmipa.laudryku.rest.LoginApiInterface;
...
public class RegisterActivity extends Activity implements EasyPermissions.PermissionCallbacks{
        ...
        userCall.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if (data != null){
                    ...
                    Log.d("huaaa","hiaa"+id_userRegistered);
                    registerLaundry();
                }
                else{
            ...
            public void onFailure(Call<User> call, Throwable t) {
                AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                builder.setTitle("Informasi");
                builder.setMessage("Periksa kembali koneksi internet anda 1");
                builder.show();
            }
        });
    }
    ...
    private void registerLaundry() {
        ...
        Call<Laundry> laundryCall = laundryApiInterface.createLaundry(id_user,nama_laundry,nama_pemilik,alamat,tlp);
        laundryCall.enqueue(new Callback<Laundry>() {
            ...
            public void onResponse(Call<Laundry> call, Response<Laundry> response) {
                ...
                if (dataResult != null){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                    builder.setTitle("Informasi");
                    builder.setMessage("Pendaftaran anda gagal (2)");
                    builder.show();
                }
            }
            ...
            public void onFailure(Call<Laundry> call, Throwable t) {
                AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                builder.setTitle("Informasi");
                builder.setMessage("Periksa kembali koneksi internet anda (2)");
                builder.show();
            }
        });
    }
